...
# Note: The shortcut for the tilde ~ is 'Alt gr'+'+' for Windows. You can also copy the 
# ~ from the description and paste it into the code
...
#To do so, you need to replace the ? with the conditions in the case_when functions.
#Tip: the structure is "(test) ~ Value"
